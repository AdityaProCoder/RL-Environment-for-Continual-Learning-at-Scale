...
Designed for GPU (P100; fp16 auto-fallback if bf16 unsupported)."""),
  ...
  code("""print("installing base packages (quiet)...")
import os, subprocess, sys, torch
os.environ["HF_TOKEN"] = os.getenv("HF_TOKEN", "")
os.environ["HUGGING_FACE_HUB_TOKEN"] = os.getenv("HF_TOKEN", "")
subprocess.check_call([sys.executable, "-m", "pip", "uninstall", "-y", "--quiet", "torchao"])
packages = ["transformers==4.44.2", "peft==0.12.0", "accelerate==0.33.0",
            "trl==0.9.6", "datasets==2.21.0", "sentence-transformers==3.0.1", "faiss-cpu",
            "matplotlib", "pandas", "scipy", "pyyaml", "jsonlines", "tqdm"]
